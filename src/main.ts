...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const scoreButtons= document.querySelectorAll<HTMLInputElement>('#jokeForm input[type="button"]');
  const selectedScoreInput= document.getElementById('selectedScore') as HTMLInputElement;
